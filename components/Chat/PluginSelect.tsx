...
export const PluginSelect: FC<Props> = ({
  ...
  return (
    <div className="flex flex-col">
      <div className="mb-1 w-full rounded border border-neutral-200 bg-transparent pr-2 text-neutral-900 dark:border-purple-700 dark:text-white">
        <select
          ref={selectRef}
        ...
        >
          <option
            key="chatgpt"
            value="chatgpt"
            className="dark:bg-[#5E548E] dark:text-white"
          >
            ChatGPT
          </option>
